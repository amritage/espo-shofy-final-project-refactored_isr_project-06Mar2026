...
function SearchParamsSync({ pathname, onQueryChange }) {
  const searchParams = useSearchParams();

  useEffect(() => {
    const urlQuery = searchParams.get('q') || searchParams.get('searchText') || '';
    onQueryChange((prev) => (prev === urlQuery ? prev : urlQuery));
  ...
  return (
    <>
      <Suspense fallback={null}>
        <SearchParamsSync pathname={pathname} onQueryChange={setSearchQuery} />
      </Suspense>
                ...
                <div className="row align-items-center mobile-header-row">
                  ...
                  <div className="col-xl-4 col-lg-10 col-md-9 col-6">
                    <div className="tp-header-bottom-right d-flex align-items-center justify-content-end header-right">
                      ...
                      <div
                        className={`tp-header-search-mobile d-lg-none ${mobileSearchOpen ? 'expanded' : ''}`}
                      ...
                      <div className="tp-header-action d-flex align-items-center header-actions">
                        ...
                        {hasSession && (
                          <div className="tp-header-action-item">
                            ...
                            >
                              <CartTwo />
                              <span className="tp-header-action-badge" key={`cart-${distinctCount}`}>
                                {distinctCount}
                              </span>
                            </button>
                          </div>
