...
/* ---------------- component ---------------- */
const WeeksFeatured = ({ initialProducts = null }) => {
  ...
  const products = React.useMemo(() => {
    ...
    const allProducts = sourceData.data;
  ...
  let content = null;
  if (!hasInitialProducts && isLoading) content = <HomeTwoFeaturedPrdLoader loading />;
  else if (!hasInitialProducts && isError) {
    content = (
